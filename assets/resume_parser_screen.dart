...
class _ResumeParserScreenState extends State<ResumeParserScreen> {
  ...
  Future<void> pickAndExtractText() async {
    ...
    if (result != null && result.files.single.path != null) {
      ...
      await extractAndParseText(file); // Extract text & details
      await roleUsingGemini(); // Extract job roles

      // Navigate to job list page with searchQuery
      Get.off(
        () => JobListScreen(searchQuery: widget.resume.jobRoles.join(",")),
      );
